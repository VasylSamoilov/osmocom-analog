/*
 * FLEX Arabic/English codepage — Motorola FLX2 Linguist (Table A-6).
 *
 ...
 * Vendor:   motorola
 * Model:    linguist
 * Charset:  arabic-english
 *
 * WARNING: Unclear image, hard to OCR.  Arabic glyphs need careful
 * verification against original FLX2 Linguist documentation.
 *
 * Mixed Arabic/English set.  Columns 0-1 contain Latin letters in
 * non-standard positions.  Column 2 has more Latin + Arabic punctuation.
 * Column 3 has digits and Latin letters.  Columns 4-7 have Arabic.
 */
...
const struct pager_charset pager_charset_flex_motorola_linguist_arabic_english = {
	.protocol  = "flex",
	.vendor    = "motorola",
	.model     = "linguist",
	.charset   = "arabic-english",
