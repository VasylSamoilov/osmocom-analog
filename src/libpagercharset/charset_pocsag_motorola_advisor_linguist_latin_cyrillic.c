/*
 * POCSAG Motorola Advisor Linguist Latin/Cyrillic codepage.
 *
 ...
 *
 * Pagers: Motorola Advisor Linguist, Scriptor LX2 Linguist,
 *         NEC Maxima, Optima, Truly Supervisor
 *
 * Layout:
 *   0x00-0x1F: Control region — special symbols from Advisor Linguist ROM.
 *   0x20-0x3F: Standard ASCII punctuation and digits.
 *   0x40-0x5F: Uppercase — Latin/Cyrillic dual-mapped lookalikes.
 *   0x60-0x7E: Cyrillic-only letters replacing Latin lowercase.
 *   0x5C,0x5E,0x5F,0x7B-0x7D: Cyrillic replacing ASCII symbols.
 *
 * Latin primary where lookalike. Lowercase maps to uppercase.
 */

#include "pager_charset.h"

static const pager_charset_entry entries[128] = {
	/* 0x00-0x1F: Control region — from our pocsag_cyrillic[] */
	/* 0x00 */ { NULL },                  /* NUL */
	/* 0x01 */ { "¤" },                   /* U+00A4 currency sign */
	/* 0x02 */ { NULL },                  /* STX */
	/* 0x03 */ { NULL },                  /* ETX */
	/* 0x04 */ { NULL },                  /* EOT */
	/* 0x05 */ { "¢" },                   /* U+00A2 cent sign */
	/* 0x06 */ { "×" },                   /* U+00D7 multiplication sign */
	/* 0x07 */ { "÷" },                   /* U+00F7 division sign */
	/* 0x08 */ { "£" },                   /* U+00A3 pound sign */
	/* 0x09 */ { "°" },                   /* U+00B0 degree sign */
	/* 0x0A */ { "\n" },                  /* LF */
	/* 0x0B */ { "«" },                   /* U+00AB left guillemet */
	/* 0x0C */ { "¿" },                   /* U+00BF inverted question */
	/* 0x0D */ { "\r" },                  /* CR */
	/* 0x0E */ { "»" },                   /* U+00BB right guillemet */
	/* 0x0F */ { "¡" },                   /* U+00A1 inverted exclamation */
	/* 0x10 */ { "\\" },                  /* backslash (remapped) */
	/* 0x11 */ { "¯" },                   /* U+00AF macron */
	/* 0x12 */ { "^" },                   /* caret (remapped) */
	/* 0x13 */ { "_" },                   /* underscore (remapped) */
	/* 0x14 */ { "§" },                   /* U+00A7 section sign */
	/* 0x15 */ { "{" },                   /* left brace (remapped) */
	/* 0x16 */ { "|" },                   /* pipe (remapped) */
	/* 0x17 */ { NULL },
	/* 0x18 */ { "}" },                   /* right brace (remapped) */
	/* 0x19 */ { "№" },                   /* U+2116 numero sign */
	/* 0x1A */ { "·" },                   /* U+00B7 middle dot */
	/* 0x1B */ { NULL },                  /* ESC */
	/* 0x1C */ { "¥" },                   /* U+00A5 yen sign */
	/* 0x1D */ { "±" },                   /* U+00B1 plus-minus */
	/* 0x1E */ { NULL },
	/* 0x1F */ { NULL },
	...
	/* 0x40-0x5F: Uppercase — Latin/Cyrillic dual-mapped.
	 * Latin primary (pager displays Latin glyphs).
	...
	/* 0x5B */ { "[" },                                       /* U+005B */
	/* 0x5C */ { "Љ", "љ" },                                  /* U+0409 cyr-Lje, U+0459 cyr-lje */
	/* 0x5D */ { "]" },                                       /* U+005D */
	/* 0x5E */ { "Њ", "њ" },                                  /* U+040A cyr-Nje, U+045A cyr-nje */
	/* 0x5F */ { "Ћ", "ћ" },                                  /* U+040B cyr-Tshe, U+045B cyr-tshe */

	/* 0x60-0x7F: Cyrillic-only letters.
	 * Lowercase maps to uppercase. */
	/* 0x60 */ { "`" },                                       /* U+0060 */
	...
	/* 0x78 */ { "Ђ", "ђ" },                                  /* U+0402 cyr-Dje, U+0452 cyr-dje */
	...
	/* 0x7B */ { "Ќ", "ќ" },                                  /* U+040C cyr-Kje, U+045C cyr-kje */
	/* 0x7C */ { "Ў", "ў" },                                  /* U+040E cyr-Short-U, U+045E cyr-short-u */
	/* 0x7D */ { "Џ", "џ" },                                  /* U+040F cyr-Dzhe, U+045F cyr-dzhe */
	/* 0x7E */ { "~" },                                       /* U+007E */
	/* 0x7F */ { NULL },                                      /* DEL */
};

/*
 * This codepage is shared by multiple pager models from different vendors.
 * All use the same character ROM / encoding.
 */

const struct pager_charset pager_charset_pocsag_motorola_advisor_linguist_latin_cyrillic = {
	.protocol  = "pocsag",
	.vendor    = "motorola",
	.model     = "advisor-linguist",
	.charset   = "latin-cyrillic-uppercase",
...
const struct pager_charset pager_charset_pocsag_motorola_scriptor_lx2_latin_cyrillic = {
	.protocol  = "pocsag",
	.vendor    = "motorola",
	.model     = "scriptor-lx2-linguist",
	.charset   = "latin-cyrillic-uppercase",
	.code_bits = 7,
	.num_codes = 128,
	.entries   = entries,
...
const struct pager_charset pager_charset_pocsag_nec_maxima_latin_cyrillic = {
	.protocol  = "pocsag",
	.vendor    = "nec",
	.model     = "maxima",
	.charset   = "latin-cyrillic-uppercase",
...
const struct pager_charset pager_charset_pocsag_nec_optima_latin_cyrillic = {
	.protocol  = "pocsag",
	.vendor    = "nec",
	.model     = "optima",
	.charset   = "latin-cyrillic-uppercase",
...
const struct pager_charset pager_charset_pocsag_truly_supervisor_latin_cyrillic = {
	.protocol  = "pocsag",
	.vendor    = "truly",
	.model     = "supervisor",
	.charset   = "latin-cyrillic-uppercase",
