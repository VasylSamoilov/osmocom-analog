/*
 * POCSAG SwissPhone DE506 English/ASCII codepage.
 *
 ...
 * Charset:  ascii
 *
 * Pagers: SwissPhone DE506 Prestige (English firmware).
 *
 * Standard 7-bit ASCII identity mapping. Full uppercase and lowercase
 * Latin alphabet with all standard punctuation and symbols.
 * No Cyrillic support.
 *
 * Layout:
...
static const pager_charset_entry entries[128] = {
	...
	/* 0x7C */ { "|" },  /* 0x7D */ { "}" },  /* 0x7E */ { "~" },  /* 0x7F */ { NULL },
};

const struct pager_charset pager_charset_pocsag_swissphone_de506_ascii = {
	.protocol  = "pocsag",
	.vendor    = "swissphone",
	.model     = "de506",
	.charset   = "ascii",
